        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-inline">
                    <label class="title"><?php echo __('Help Topic'); ?>: </label>
            ...
            <div class="col-md-6">
                <div class="items-search pull-right">
                    <div class="form-inline">
                        <input type="hidden" name="a"  value="search">
                        <div class="input-group">
                            <input class="form-control rounded rounded-s" type="text" name="keywords" size="30" value="<?php echo Format::htmlchars($settings['keywords']); ?>">
                            <input class="btn btn-secondary rounded-s" type="submit" value="<?php echo __('Search');?>">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card card-block sameheight-item">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <?php if ($settings['keywords'] || $settings['topic_id'] || $_REQUEST['sort']) { ?>
                                <? if($settings['keywords']) ?><span class="badge badge-pill badge-info">Keywords</span>
                                <? if($settings['topic_id']) ?><span class="badge badge-pill badge-primary">By Topic</span>
                                <div><strong><a href="?clear" style="color:#777"><i class="icon-remove-circle"></i> <?php echo __('Clear all filters and sort'); ?></a></strong></div>
                            <?php } ?> <br>
                        </div>
                        <hr>
                        <div class="col-md-6">
                            <h3 class="title"><a class="text-danger" href="<?php echo Format::htmlchars($_SERVER['REQUEST_URI']); ?>"
                        ...
                        <div class="col-md-6">
                            ...
                            <?php if ($openTickets) { ?>
                                ...
                                <a class="state <?php if ($status == 'open') echo 'active text-success'; ?>"
                            ...
                            if ($closedTickets) {?>
                                ...
                                <a class="state <?php if ($status == 'closed') echo 'active text-warning'; ?>"
                ...
                <section>
                    <div class="table-flip-scroll">
                        <table id="ticketTable" class="table table-striped table-bordered table-hover flip-content">
